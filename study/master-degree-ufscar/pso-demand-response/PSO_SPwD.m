function PSO_SPwD(dispositivos, tarifa, H, tamNuvem, nIter, c1, c2, wMin, wMax, salvarDadosTeste)
    ...
    if (salvarDadosTeste);
        ...
        % 3 = PSO_SPwD
        % 4 = PSO_SPwA
        dadosTeste = [X 3 nIter tamNuvem c1 c2 wMin wMax gBestData{1} ...
